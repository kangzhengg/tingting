...
const App: React.FC = () => {
  ...
  const updateCharacterAge = (age: AppState['characterAge']) => {
    setAppState(prev => ({ ...prev, characterAge: age }));
  };
        ...
        <main className="flex-grow container mx-auto px-4 py-8 relative">
          <Routes>
            ...
            <Route path="/customize" element={<Customize 
              ...
              updateCharacterAge={updateCharacterAge}
              t={t} 
            />} />
            <Route path="/credits" element={<Credits t={t} accentColor={appState.accentColor} />} />
          </Routes>
          
          <BGMPlayer accentColor={appState.accentColor} />
        </main>
